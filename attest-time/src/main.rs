...
struct Args {
    ...
    #[cfg_attr(feature = "ipcc", clap(value_enum, long, default_value_t = Interface::Ipcc))]
    #[cfg_attr(not(feature = "ipcc"), clap(value_enum, long, default_value_t = Interface::Hiffy))]
    interface: Interface,
